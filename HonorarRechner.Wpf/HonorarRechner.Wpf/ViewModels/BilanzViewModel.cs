...
namespace HonorarRechner.Wpf.ViewModels
{
    public class BilanzViewModel : INotifyPropertyChanged
    {
        ...
        // Helper für Setter (damit Eingabe funktioniert)
        ...
        public string AufstellungInput { get => ToEuro(_aufstellungWert); set => SetDecimal(value, ref _aufstellungWert); }
        ...
        public string AntragInput { get => ToEuro(_antragWert); set => SetDecimal(value, ref _antragWert); }
        ...
        public string SteuerbilanzInput { get => ToEuro(_steuerbilanzWert); set => SetDecimal(value, ref _steuerbilanzWert); }
        ...
        public string KoerperschaftInput { get => ToEuro(_koerperschaftWert); set => SetDecimal(value, ref _koerperschaftWert); }
        ...
        public string UstInput { get => ToEuro(_ustWert); set => SetDecimal(value, ref _ustWert); }
        ...
        public string GewerbeInput { get => ToEuro(_gewerbeWert); set => SetDecimal(value, ref _gewerbeWert); }
        ...
        public string BescheidAnzahl
        {
            ...
            set
            {
                if (int.TryParse(value, out int result)) { _bescheidAnzahlInt = result; RecalculateFees(); }
                OnPropertyChanged();
            }
        }
        ...
        private void InitializeBaseValues()
        {
            ...
            // KSt JETZT IMMER INITIALISIEREN (auch für EU)
        ...
        private void RecalculateFees()
        {
            ...
            // Einziger Unterschied: Mindestgebühr
        ...
        {
            OnPropertyChanged(nameof(AufstellungInput)); OnPropertyChanged(nameof(AntragInput));
            OnPropertyChanged(nameof(SteuerbilanzInput)); OnPropertyChanged(nameof(KoerperschaftInput));
            OnPropertyChanged(nameof(UstInput)); OnPropertyChanged(nameof(GewerbeInput));

            OnPropertyChanged(nameof(AufstellungText)); OnPropertyChanged(nameof(AntragText));
            OnPropertyChanged(nameof(SteuerbilanzText)); OnPropertyChanged(nameof(KoerperschaftText));
            OnPropertyChanged(nameof(UstText)); OnPropertyChanged(nameof(GewerbeText));

            OnPropertyChanged(nameof(BescheidText)); OnPropertyChanged(nameof(ZwischenSummeJahr)); OnPropertyChanged(nameof(ZwischenSummeMonat));
        }
