...
namespace HonorarRechner.Wpf.ViewModels
{
    public class LeistungenViewModel : INotifyPropertyChanged
    {
        ...
        // WeiterRequested entfernt/ignoriert, da es hier nicht weitergeht
        ...
        public LeistungenViewModel()
        {
            ...
            // WICHTIG: WeiterCommand existiert nicht mehr (bzw. ist null)
        ...
        // --- Checkboxen ---
        private bool _fiBu;
        public bool FiBu { get => _fiBu; set { if (Set(ref _fiBu, value)) { _daten.HatFiBu = value; if (value) Selbstbucher = false; Recalculate(); } } }

        private bool _selbstbucher;
        public bool Selbstbucher { get => _selbstbucher; set { if (Set(ref _selbstbucher, value)) { _daten.IstSelbstbucher = value; if (value) FiBu = false; Recalculate(); } } }

        private bool _ja;
        public bool JA { get => _ja; set { if (Set(ref _ja, value)) { _daten.HatJahresabschluss = value; Recalculate(); } } }

        private bool _lohn;
        public bool Lohn { get => _lohn; set { if (Set(ref _lohn, value)) { _daten.HatLohn = value; Recalculate(); } } }
        ...
        // HIER IST DER TRICK: WeiterCommand gibt NULL zurück -> Button wird unsichtbar
